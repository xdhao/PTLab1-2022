...
class TestQuartileRating:
    ...
    def input_data_two(self) -> tuple[DataType, list]:
        data: DataType = {"Иванов Иван Иванович": [("math", 80),
                          ("prin", 90), ("litra", 76)],
                          "Петров Петр Петрович": [("math", 100),
                          ("soc", 90), ("chemistry", 61)],
                          "Петров Иван Петрович": [("math", 95),
                          ("soc", 67), ("chemistry", 85)],
                          "Иванов Петр Петрович": [("math", 100),
                          ("soc", 100), ("chemistry", 100)],
                          "Петров Петр Иванович": [("math", 90),
                          ("soc", 90), ("chemistry", 90)],
                          "Иванов Иван Петрович": [("math", 61),
                          ("soc", 61), ("chemistry", 61)],
                          "Савельев Петр Петрович": [("math", 64),
                          ("soc", 75), ("chemistry", 89)],
                          "Алексеев Петр Петрович": [("math", 62),
                          ("soc", 68), ("chemistry", 72)],
                          "Петров Игорь Петрович": [("math", 95),
                          ("soc", 94), ("chemistry", 93)],
                          "Соколов Петр Петрович": [("math", 91),
                          ("soc", 91), ("chemistry", 90)],
                          "Орлов Александр Петрович": [("math", 89),
                          ("soc", 88), ("chemistry", 87)],
                          "Воробьев Петр Иванович": [("math", 86),
                          ("soc", 85), ("chemistry", 84)],
                          "Котов Петр Петрович": [("math", 83),
                          ("soc", 82), ("chemistry", 81)],
                          "Волков Петр Петрович": [("math", 80),
                          ("soc", 79), ("chemistry", 78)],
                          "Александров Петр Петрович": [("math", 77),
                          ("soc", 76), ("chemistry", 75)],
                          "Ильин Петр Петрович": [("math", 74),
                          ("soc", 73), ("chemistry", 72)]}
